...
- ⏱️ **Automated Tracking:** Automatically logs the exact entry time, exit time, and total duration for each person.
- 🗄️ **Local Database:** Uses SQLite to store attendance session records reliably.
...
> ⚠️ **Important:** You must navigate into the `src` folder before running the application, otherwise it will fail to find the local database and models!
...
- 🗃️ **View Database:** Opens a table viewing all raw attendance records.
